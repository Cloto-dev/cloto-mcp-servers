#!/usr/bin/env bash
# setup-deps.sh -- Install Python dependencies for all MCP servers.
#
# Creates a shared virtual environment at servers/.venv and installs
...
VENV_DIR="$PROJECT_ROOT/servers/.venv"
...
if [[ ! -d "$VENV_DIR" ]]; then
    echo "Creating virtual environment at servers/.venv ..."
...
echo "  source servers/.venv/bin/activate       # Linux/macOS"
echo "  source servers/.venv/Scripts/activate    # Windows (Git Bash)"
